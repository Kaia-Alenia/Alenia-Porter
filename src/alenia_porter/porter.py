    ...
    if not _locales_error_shown:
        ...
        try:
            ...
            message = (
                ...
                "3. Descargue e instale una copia limpia de la v6.0 desde GitHub o Itch.io.\n\n"
                "--------------------------------------------------\n\n"
                ...
                "3. Download and install a clean copy of v6.0 from GitHub or Itch.io."
            )
